...
```{r message=FALSE}
#Set working directory (change according to your system)
#Make sure to download the CRU precipitation data to the wkdir
...
#Extract netCDF data and place precipitation data ('pre') in the variable 'Rain0'
Rain.NC <- open.ncdf("africa_cru_3.0.1961.2006.meanAnnPrec.nc")
Rain <- get.var.ncdf(Rain.NC,"pre")

#We can get coordinate values too. Maybe someone can then use these in the ggplot call!
...
#Then call ggplot with x and y values as the X1 and X2 variables created by melt
